...
const test = () => {
 ...
 <SwiperSlide className="select-none">
          ...
          <div
            ...
            className="absolute top-[175px] left-8 z-10 cursor-pointer sm:invisible lg:visible"
          >
            <svg
          ...
          <div
            ...
            className="absolute top-[175px] right-8 z-10 cursor-pointer sm:invisible lg:visible"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 25 25"
